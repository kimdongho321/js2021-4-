...
<h1>File System 모듈</h1><br>

비동기 처리의 장점<br>
>-웹 서버를 C++ 프로그래밍 언어로 만들면 빠르지만 개발과 유지보수는 어려움<br>
-전세계 웹 서비스 기업도 C++로 웹서버를 개발하지 않고
PHP,자바,루비,파이썬,Node.js 등 프로그래밍 언어로 개발<br>
...
fs.writeFileSync(<"파일이름">,<"문자열">) > 동기적으로 파일은 씀<br>
fs.writeFile(<"파일이름">,<"문자열">) > 비동기적으로 파일은 씀<br>
